...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center ' >
      <h1 className='p-6 ml-4 text-4xl text-[#FFFFFF]'>Edibite</h1>
      ...
      <div>
        ...
        <button onClick={() => setIsModalROpen(true)} className='text-[8px] mr-8 bg-slate-300 rounded-lg p-2 whitespace-nowrap text-[#000000] '>For Restaurants</button></div>
