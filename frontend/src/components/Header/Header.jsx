  ...
  return (
    <div className='p-6 sm:flex'>
      <div className='max-w-[800px]'>
        <p className='text-4xl mx-4 text-white'>Rescue Food, <span className='whitespace-nowrap'>Save Money,</span> <span className='whitespace-nowrap'>Make a Difference!</span></p>
